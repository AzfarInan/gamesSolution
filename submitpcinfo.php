            ...
            <form method="get" action="insert.php">
                ...
                <tr>
                    ...
                    <td  style="display: none">
                        <input type="text" name="user-cpu" id="user-cpu">
                    </td>
                ...
                <tr>
                    ...
                    <td  style="display: none">
                        <input type="text" name="user-gpu" id="user-gpu">
                    </td>
                ...
                <tr>
                    ...
                    <td  style="display: none">
                        <input type="text" name="user-ram" id="user-ram">
                    </td>
                ...
                <tr>
                    <td colspan="2" style="text-align: center;">
                        <input  type="submit" name="submit" value="Submit" onmouseover="this.style.background = 'black';" onmouseout="this.style.background = '#5e0101';" style="padding: 10px; cursor: pointer; border: none; border: 1px solid #5e0101; border-radius: 15px; background-color: #5e0101; color: white; font-size: 110%; padding-left: 150px; padding-right: 150px">
                    </td>
                </tr>
            </form>
        </table>
